...
class Application:
    ...
    def __init__(self):
        ...
        # Set up dark theme colors and fonts
        label_bg = "#181818"
        label_fg = "#f8f8ff"
        panel_bg = "#181818"
        panel_border = "#181818"
        button_bg = "#181818"
        button_fg = "#f8f8ff"
        button_active_bg = "#00bcd4"
        button_active_fg = "#181818"
        accent = "#00bcd4"
        font_main = ("Segoe UI", 30, "bold")
        font_label = ("Segoe UI", 22, "bold")
        ...
        try:
            ...
            logo_img = Image.open("logo.png").convert("RGBA").resize((96, 96), Image.LANCZOS)
            ...
            self.logo_label = tk.Label(self.root, image=self.logo_photo, bg=label_bg, bd=0)
            self.logo_label.place(x=30, y=20)
        except Exception as e:
            print(f"Logo image could not be loaded: {e}")
            self.logo_label = tk.Label(self.root, text="", bg=label_bg)
            self.logo_label.place(x=30, y=20)

        self.T = tk.Label(self.root, bg=label_bg, fg=accent, text="Langify – Sign to Sentence", font=font_main)
        self.T.place(x=150, y=30)

        self.panel = tk.Label(self.root, bg=panel_bg, bd=2, relief=tk.GROOVE, highlightbackground=panel_border)
        self.panel.place(x=180, y=100, width=480, height=500)

        self.panel2 = tk.Label(self.root, bg=panel_bg, bd=2, relief=tk.GROOVE, highlightbackground=panel_border)
        self.panel2.place(x=700, y=100, width=480, height=500)

        self.panel3 = tk.Label(self.root, bg=panel_bg, fg=label_fg, font=font_label, bd=1, relief=tk.FLAT)
        self.panel3.place(x=280, y=620)

        self.T1 = tk.Label(self.root, bg=label_bg, fg=label_fg, font=font_label, text="Character :")
        self.T1.place(x=10, y=620)

        self.panel5 = tk.Label(self.root, bg=panel_bg, fg=label_fg, font=font_label, bd=1, relief=tk.FLAT)
        self.panel5.place(x=260, y=670)

        self.T3 = tk.Label(self.root, bg=label_bg, fg=label_fg, font=font_label, text="Sentence :")
        self.T3.place(x=10, y=670)

        self.T4 = tk.Label(self.root, bg=label_bg, fg=accent, font=font_label, text="Suggestions :")
        self.T4.place(x=10, y=720)

        button_style = dict(bg=button_bg, fg=button_fg, activebackground=button_active_bg, activeforeground=button_active_fg, font=font_button, relief=tk.FLAT, bd=2, highlightbackground=accent, highlightthickness=2)
        # Suggestion buttons moved slightly upwards
        self.b1 = tk.Button(self.root, **button_style, wraplength=825, command=self.action1)
        self.b1.place(x=390, y=730)
        self.b2 = tk.Button(self.root, **button_style, wraplength=825, command=self.action2)
        self.b2.place(x=590, y=730)
        self.b3 = tk.Button(self.root, **button_style, wraplength=825, command=self.action3)
        self.b3.place(x=790, y=730)
        self.b4 = tk.Button(self.root, **button_style, wraplength=825, command=self.action4)
        self.b4.place(x=990, y=730)

        self.speak = tk.Button(self.root, bg=accent, fg=label_bg, activebackground=button_bg, activeforeground=accent, font=font_button, wraplength=100, command=self.speak_fun, relief=tk.FLAT, bd=2, highlightbackground=accent, highlightthickness=2)
        self.speak.place(x=1305, y=700)
        self.speak.config(text="Speak")

        self.clear = tk.Button(self.root, **button_style, wraplength=100, command=self.clear_fun)
    ...
    def video_loop(self):
        try:
            ...
            hands = hd.findHands(cvimage, draw=False, flipType=True)
            cv2image_copy=np.array(cvimage)
